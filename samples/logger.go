...
// Đây là file mẫu của Hashicorp Vault về cách setup logger
// Các pattern khởi tạo log của Vault rất hay và linh hoạt,
// nên ta có thể tham khảo để cải thiện logger của mình
